...
NetworkManagerServer::NetworkManagerServer() :
	...
	mServerDisconnectTimeout(15.f) 
{
	mTimeToCloseServer = Timing::sInstance.GetFrameStartTime() + mServerDisconnectTimeout;
}
...
void NetworkManagerServer::HandleClientDisconnected( ClientProxyPtr inClientProxy )
{
	...
	{
		if (Timing::sInstance.GetFrameStartTime() > mTimeToCloseServer)
		{
			// We'll keep server alweays open instead of shutting down !!!
