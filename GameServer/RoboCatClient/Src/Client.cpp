...
Client::Client()
{
	GameObjectRegistry::sInstance->RegisterCreationFunction( 'PLER', RoboCatClient::StaticCreate );
	GameObjectRegistry::sInstance->RegisterCreationFunction( 'BUGS', MouseClient::StaticCreate );
