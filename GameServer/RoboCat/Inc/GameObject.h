...
public:
	...
	virtual bool	HandleCollisionWithOther( GameObject* inGO ) { ( void ) inGO; return true; }
	...
	//const Vector3&		GetColor()					const				{ return mColor; }
			...
			void		SetColor(uint8_t inColor) { mColorState = inColor; }
			uint8_t	GetColor()					const { return mColorState; }
